                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-12">
                                <div class="card shadow-lg border-0 rounded-lg mt-0">
                                    <div class="card-header"><h4 class="text-left" style="color: #FF9900;"> Direct Purchase <button class="small float-right btn btn-primary btn-xs" id="show"><i class="fa fa-plus-circle"></i> Add New</button></h4>
									</div>
...
<!--Start hidden table from here-->		
	...
	@csrf
		<table class="table-sm table-bordered" width="98%" >
			...
			<tbody>
				<tr>
					<td colspan="8" style="text-align:center;"><input type="text" name="" value="Total" class="form-control form-control-sm text-right" readonly style="background-color:#D8FDBA;"></td>
				...
				<tr>
					<td colspan="8" style="text-align:center;"><input type="text" name="" value="Carrying Charge" class="form-control form-control-sm text-right" style="background-color:#99FFFF;"></td>
				...
				<tr>
					<th colspan="8" style="text-align:center;"><input type="text" name="" value="Advanced Amount" class="form-control form-control-sm text-right" readonly style="background-color:#99FFCC;">
					</th>
				...
				<tr>
					<td colspan="8" style="text-align:center;"><input type="text" name="" value="Special Discount" class="form-control form-control-sm text-right" style="background-color: #99FF99;"></td>
				...
				<tr>
					<th colspan="8" style="text-align:center;"><input type="text" name="" value="Grand Total" class="form-control form-control-sm text-right" readonly style="background-color:#66FF66;">
					</th>
		...
		<div class="col-md-2" style="float:left;">
			<select name="pay_type" class="form-control form-control-md select2" required>
				<option value="">Select Pay Type</option>
				@foreach($pay_types as $pay_type)
				<option value="{{ $pay_type->id }}" >{{ $pay_type->h_name }}</option>
				@endforeach
			</select>
		</div>
		<div class="col-md-2" style="float:left;">
			<button type="submit" class="form-control form-control-md btn btn-primary" id="storeButton" onClick="return confirm('Are you sure, you want to Save the Purchase?');">Purchase Confirm</button>
		</div>
		</form>
	</div>
<!-- End hidden table -->
