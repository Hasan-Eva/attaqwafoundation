...
td, th {
	...
	<body>
		...
		<table>
			<thead>
				<tr>
					<td colspan="6" style=" text-align:center; border:none; font-size:20px;">IMPETUS Center Owners Association</td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="6" style=" text-align:center; border:none;">Purchase Report</td>
				</tr>
				<tr>
					<td colspan="6" style=" text-align:center; border:none;">Period: {{  date("d.m.Y", strtotime($f_date)) }} to {{  date("d.m.Y", strtotime($t_date)) }}</td>
				</tr>
				<tr>
					<td style="height:10px; border:none;"></td>
				</tr>
