...
td, th {
	...
	<img style="height: 50px;width: 70px;" src="{{ asset('public/images/logo/logo.png') }}" >
		<table>
			<thead>
				<tr>
					<th colspan="10" style=" text-align:center; border:none; font-size:18px;"><i>IMPETUS Center Owners Association</i></th>
				</tr>
				<tr>
					<td colspan="10" style=" text-align:center; border:none;">24/B, Tejgaon Gulshan Link Road, Dhaka</td>
				</tr>
				<tr>
			...
			<tbody>
				@php $sl=1; $total=0; $total_advance=0; $total_mobile_bill=0; $total_payable=0; $total_absent=0; @endphp
	...
	<img style="height: 50px;width: 70px;" src="{{ asset('public/images/logo/logo.png') }}" >
		<table>
			...
			<tbody>
				@foreach($release_cleaners as $data)
				<tr>
				<?php 
						$month_days = intval(date('t', strtotime($t))); 
							$absent= Absent_cleaner::where('emp_id',$data->id)->whereBetween('date',[$f,$t])->first();
