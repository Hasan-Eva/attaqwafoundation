	...
	<body>
		<table>
			<thead>
				...
				<tr>
					<td colspan="7" style=" text-align:center; border:none;">All Staff Report</td>
				</tr>
				<tr>
					<td colspan="7" style=" text-align:center; border:none;">As On: {{  date("d.m.Y", strtotime($t_date)) }}</td>
				</tr>
				<tr>
					<td style="height:10px; border:none;"></td>
				</tr>
				<tr>
					...
					<th style="text-align:center; width:120px;">Department</th>
					<th style="width:100px; width:75px;">Posting</th>
					<th style="width:100px; width:80px; ">Salary</th>
				</tr>
			</thead>
			<tbody>
				@php $total=0; @endphp
				...
				<tr>
					...
					<td style="text-align:right;">{{ number_format($data->total_salary,2,".",",") }} <?php $total+=$data->total_salary; ?></td>
				</tr>
				@endforeach
			</tbody>
			<tfoot>
		...
		<table>
			...
			<tbody>
				...
				<tr>
					...
					<td style="text-align:left;">{{ $data->designation_name }}</td>
					<td>{{  date("d.m.Y", strtotime($data->joining_date)) }}</td>
					<td style="text-align:left;">Security Guard</td>
					<td style="text-align:left;">{{ $data->location_name }}</td>
					<td style="text-align:right;">{{ number_format($data->total_salary,2,".",",") }} <?php $total+=$data->total_salary; ?></td>
				</tr>
				@endforeach
