...
td, th {
	...
	<div style="page-break-after:always; padding-left:50px;">
		...
		<table>
			<tbody>
				<tr>
					<td colspan="3" style=" text-align:left; border:none; height:25px;"></td>
					<td style=" text-align:center; border:none;"></td>
					<th colspan="3" style=" text-align:left; border:none; width:330px;">Bonus </th>
					
					<td style=" text-align:right; border:none;"> </td>
					<td style=" text-align:right; border:none;">{{ number_format($data->total_salary/2,0,".",",") }}</td>
				</tr>
				<tr>
					<td colspan="3" style=" text-align:left; border:none; height:25px;"></td>
					<td style=" text-align:center; border:none;"></td>
					<td colspan="3" style=" text-align:left; border:none;">{{ $data->name }} ( {{ $data->designation_name }} )</td>
		...
		<table>
				<tr>
					...
					<th style="text-align:right;">{{ number_format($data->total_salary/2,0,".",",") }}</th>
...
<!-- For Guards -->
	...
	<div style="page-break-after:always; padding-left:50px;">
		...
		<table>
			...
			<tr>
				<th style="height:70px; border:none;"></th>
			</tr>
			<tr>
	...
	<div style="page-break-after:always; padding-left:50px;">
		...
		<table>
			<thead>
				...
				<tr>
					<th colspan="9" style=" text-align:center; border:none; font-size:20px;"><u>Bonus Sheet </u></th>
				</tr>
				<tr>
					<td style="height:10px; border:none;"></td>
				</tr>
			...
			<tbody>
				...
				<tr>
					...
					<td style=" text-align:center; border:none;">:</td>
					<th colspan="3" style=" text-align:left; border:none;"> {{  date("F, Y") }}</th>
