            ...
            <div class="card">
				...
				<div class="col-md-12 small mb-0">
					...
					<div style="float:left; padding-left:10px;">
						<button type="submit" class="btn btn-secondary btn-xs" data-toggle="modal" data-target="#voucherviewModal"><i class='fa fa-list'></i> Stock (View)</button></label>
                    </div>
							...
							<div class="modal-dialog modal-sm" role="document">
								<div class="modal-content">
									<div class="modal-header">
										<h6 class="modal-title" id="exampleModalLabel" style="color:#00CC00;">Stock View</h6> <span style="padding-left:10px; color: #000066;"> </span>
										<button type="button" class="close" data-dismiss="modal" aria-label="Close">
											<span aria-hidden="true">&times;</span>
										</button>
									</div>
									<form id="search_form" action="{{ route('inventory_report.stock') }}" method="POST" id="editForm">
									{{ csrf_field() }}
					...
					<div style="float:left; padding-left:10px;">
						<button type="submit" class="btn btn-success btn-xs" data-toggle="modal" data-target="#voucherpdfModal"><i class='fas fa-file-pdf'></i> Stock (PDF)</button></label>
                    </div>
					<!-- Start Voucher PDF Modal -->
						<div class="modal fade" id="voucherpdfModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
							<div class="modal-dialog modal-sm" role="document">
								<div class="modal-content">
									<div class="modal-header">
										<h6 class="modal-title" id="exampleModalLabel" style="color:#00CC00;">Stock PDF</h6> <span style="padding-left:10px; color: #000066;"> </span>
										<button type="button" class="close" data-dismiss="modal" aria-label="Close">
											<span aria-hidden="true">&times;</span>
										</button>
									</div>
									<form action="{{ route('inventory_report.stock.pdf') }}" method="POST" target="_blank">
									{{ csrf_field() }}
									<div class="modal-body">
										<div class="form-group">
											<label for="recipient-name" class="col-form-label">As On</label>
					...
					<div class="modal fade" id="myModal" style="overflow:hidden;" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
					  <div class="modal-dialog modal-ml" role="document">
						<div class="modal-content">
						  <div class="modal-header">
							<h5 class="modal-title" id="exampleModalLabel">Product Wise (View)</h5>
							<button type="button" class="close" data-dismiss="modal" aria-label="Close">
							  <span aria-hidden="true">&times;</span>
							</button>
						  </div>
              ...
              <div class="card-body">
               	...
               	@if(isset($stocks))
					@include('backend.pages.report.stock.body.stock_view') 
				@endif
