...
<section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header"><h4 class="text-left" style="color: #FF9900;"> Advance List (Cleaner)<button class="small float-right btn btn-warning btn-sm" data-toggle="modal" data-target="#advanceModal"><i class="fa fa-plus-circle"></i> Add New</button></h4>						
			  </div>
					  ...
					  <div class="modal-dialog modal-ml" role="document">
						<div class="modal-content">
						  <div class="modal-header">
							<h5 class="modal-title" id="exampleModalLabel">Advance Input Form( Cleaners )</h5>
							<button type="button" class="close" data-dismiss="modal" aria-label="Close">
							  <span aria-hidden="true">&times;</span>
							</button>
						  </div>
						   <form id="search_form" action="{{ route('advance.cleaner.store') }}" method="POST" id="editForm">
							@csrf
						  <div class="modal-body">
							<div class="col-sm-6 float-left">
								<div class="form-group">
									<label for="recipient-name" class="col-form-label">Advance Date:</label>
...
<script type="text/javascript">
    $(document).ready(function() {
		...
		var table = $('.ytable').DataTable({
			processing: true,
			serverSide: true,
			ajax: "{{ route('advance.cleaner.view') }}",
			columns: [
