	...
	<table>
		<tr>
			...
			<th rowspan="4" style=" padding-left:20px;">
				<img src="{{ asset('public/images/staff/'. $staffs->image) }}" class="img-circle elevation-2" alt="Card image" width="50px;" /> 
			</th>
		</tr>
		<tr>
		...
		<tr>
			<td>{{ $staff_file->department->department_name }}</td>
		</tr>
		<tr>
...
<form id="search_form" action="{{ route('personal_file.staff_file_store') }}" method="POST" enctype="multipart/form-data">
@csrf
<div class="col-md-12 float-left">
