...
<section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header"><h4 class="text-left" style="color: #FF9900;"> Size List <button class="small float-right btn btn-warning btn-sm" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus-circle"></i> Add New</button></h4>
  ...
  <div class="modal-dialog modal-ml" role="document">
    <div class="modal-content">
      <div class="modal-header">
	   ...
	   <form id="search_form" action="{{ route('size.store') }}" method="POST" id="editForm">
		@csrf
      <div class="modal-body">
	  	<div class="col-sm-12 float-left">
			<div class="form-group">
				<small>Brand Name:</small>
				<input type="text" name="size_name" class="form-control" id="size_name" placeholder="Input New Category Name" value="" required>
...
<div class="modal" id="EditModal">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title">Edit Size Name</h4>
