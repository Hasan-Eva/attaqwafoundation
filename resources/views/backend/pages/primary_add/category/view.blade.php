...
<section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header"><h4 class="text-left" style="color: #FF9900;"> Category List <button class="small float-right btn btn-warning btn-sm" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus-circle"></i> Add New</button></h4>
  ...
  <div class="modal-dialog modal-ml" role="document">
    <div class="modal-content">
      <div class="modal-header">
	   ...
	   <form id="search_form" action="{{ route('category.store') }}" method="POST" id="editForm">
		@csrf
      <div class="modal-body">
	  	<div class="col-sm-12 float-left">
			<div class="form-group">
				<small>Category Name:</small>
				<input type="text" name="category_name" class="form-control" id="category_name" placeholder="Input New Category Name" value="" required>
...
$(document).ready(function() {
        ...
        $('body').on('click', '#getDeleteData', function(e) {
           ...
           var id = $(this).data('id');
            $.ajax({
                url:"{{route('category.delete_view')}}",
                method: 'GET',
                data: {
                    id:id
                 },
