	...
	<table>
		<tr>
			...
			<th rowspan="4" style=" padding-left:20px;">
				<img src="{{ asset('public/images/guard/'. $staffs->image) }}" class="img-circle elevation-2" alt="Card image" width="50px;" /> 
			</th>
		</tr>
		<tr>
...
<form id="search_form" action="{{ route('personal_file.guard_file_store') }}" method="POST" enctype="multipart/form-data">
@csrf
<div class="col-md-12 float-left">
	...
	<div class="form-group col-md-3 float-left">
		...
		<select class="form-control select2" name="jobtype" style="width: 100%;" required>
			...
			<option value="Probationary" {{($staff_file->jobtype == "Regular")?"Selected":'' }}>Regular</option>
