...
<section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header"><h4 class="text-left" style="color: #FF9900;"> Post List <button class="small float-right btn btn-warning btn-sm" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus-circle"></i> Add New</button></h4>
              ...
              <div class="card-body">
                  ...
                  <thead>
					  <tr>
						<th width="5%">SL</th>
						<th width="25%">Post Header</th>
						<th width="50%">Post Details</th>
  ...
  <div class="modal-dialog modal-ml" role="document">
    <div class="modal-content">
      <div class="modal-header">
	   ...
	   <form id="search_form" action="{{ route('post.store') }}" method="POST" id="editForm" enctype="multipart/form-data">
		@csrf
      <div class="modal-body">
	  	<div class="col-sm-12 float-left">
			<div class="form-group">
				<small>Post Headings:</small>
				<input type="text" name="head" class="form-control" id="head" placeholder="Input New Category Name" value="" required>
